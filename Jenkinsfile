pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = "${DOCKERHUB_USERNAME}/canara_whitehorse"
        DOCKER_CONTAINER = 'canara_app_whitehorse'
    }
    ...
    parameters {
        ...
        string(name: 'RECEIVER_EMAIL', defaultValue: 'geethar272003@gmail.com', description: 'Comma-separated recipient emails')
    }
